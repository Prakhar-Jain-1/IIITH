...
class MarksManager:
    ...
    def addEntry(self):
        try:        
            ...
            print(f"Error: {ve}. Please enter a valid value.")
    ...
    def searchEntry(self):
        try:
            search_attributes = input("Enter the attributes to search for (e.g., FirstName, Semester, lastname, rollno, semester, coursename, examtype): ").strip().lower().split(',')
            ...
            if(len(search_attributes) < 1 or search_attributes[0] != ""):
